...
{
    // Allocate three node objects within heap memory.
    Node<int>* p_node1 = new Node(10);
    Node<int>* p_node2 = new Node(20);
    Node<int>* p_node3 = new Node(30);
...
{
    Node<double>* p_node1 = new Node(10.1);
    Node<double>* p_node2 = new Node(20.2);
    Node<double>* p_node3 = new Node(30.3);
